...
const dailyIntake = [
  2000, 1500, 1800, 1900, 1600, 1700, 2300, 2000, 1500, 1800, 1900, 1600, 1700,
  2000, 1500, 1800, 1900, 1600, 1700, 2000, 1500, 1800,
];
...
const WaterIntakeForm: React.FC = () => {
  ...
  const [waterIntake, setWaterIntake] = useState<number | null>(
    user.currentIntake
  );
      ...
      {suggestedIntake !== 0 && (
        <div>
          ...
          <p className="text-lg font-bold">
            {waterIntake} mL ({(suggestedIntake / 250).toFixed(2)} cups) per day
          </p>
